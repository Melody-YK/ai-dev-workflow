...
Human gates are default behavior for meaningful decisions: blocking requirements clarifications, prototype approval, and implementation execution approval. Do not treat 00→01 as a human gate when the user has already asked to run ai-dev-workflow; initialize artifacts, then immediately enter 01 and ask real clarification questions if needed.
